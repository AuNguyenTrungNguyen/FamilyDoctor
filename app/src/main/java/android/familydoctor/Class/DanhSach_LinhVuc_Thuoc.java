...
public class DanhSach_LinhVuc_Thuoc {
    static String[] khuvuc={"Khu vực","Tất cả","Cần Thơ","Đà Nẵng","Hồ Chí Minh","Trà vinh","Sóc Trăng","An Giang",
            ...
            "Đồng Nai","Đồng Tháp","Gia Lai","Hà Nội","Hà Giang","Hà Nam","Hà Tĩnh","Hải Dương",
            "Hải Phòng","Hậu Giang","Hoà Bình","Hưng Yên","Kiên Giang","Kon Tum","Khánh Hoà",
            "Lai Châu", "Lào Cai","Lạng Sơn","Lâm Đồng","Long An","Nam Định","Ninh Bình",
            "Ninh Thuận","Nghệ An","Phú Thọ","Phú Yên","Quảng Bình","Quảng Nam",
