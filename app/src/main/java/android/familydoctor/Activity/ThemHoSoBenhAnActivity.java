...
public class ThemHoSoBenhAnActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (requestCode == REQUEST_CODE && resultCode == RESULT_CODE && data != null) {
            ...
            ArrayList<Thuoc> listThuocTrongHoSoBenhAn;

            listThuocTrongHoSoBenhAn = (ArrayList<Thuoc>) data.getSerializableExtra("listThuocSeThem");

            Toast.makeText(this, listThuocTrongHoSoBenhAn.size(), Toast.LENGTH_SHORT).show();
        }
    }
}
